...
public class StateMachineTest {
    ...
    static class Context{
        String operator = "cookie";
        String entityId = "123465";
    }

    @Test
    @DisplayName("test whether the state is changed when the condition is met")
    ...
    @Test
    @DisplayName("test whether the state is changed when the condition is met and raw state is among multiple states")
    public void testExternalTransitionsNormal(){
        ...
        assertEquals(States.STATE4, target);
    }

    @Test
    @DisplayName("test whether the state is changed when internal event is fired")
    public void testInternalNormal(){
        ...
        assertEquals(States.STATE1, target);
    }

    @Test
    @DisplayName("test whether the state is changed when external and internal event is fired")
    public void testExternalInternalNormal(){
        ...
        assertEquals(States.STATE3, target);
    }
    ...
    @Test
    @DisplayName("test whether the state is changed when external and internal event is fired by multiple threads")
